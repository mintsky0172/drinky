...
import { getReportById, updateReportStatus } from "@/src/lib/admin/adminApi";
      ...
      >
        <ScrollView contentContainerStyle={styles.container}>
          <View style={styles.headerRow}>
            ...
            <AppText preset="h1">제보 상세</AppText>
            <View style={{ width: 22 }} />
          </View>
          ...
          <View style={styles.sectionCard}>
            ...
            <AppText preset="h3" style={styles.metaText}>
              • 종류:{" "}
              {item.type === "new_drink" ? "새 음료 제보" : "단종 음료 제보"}
            </AppText>
